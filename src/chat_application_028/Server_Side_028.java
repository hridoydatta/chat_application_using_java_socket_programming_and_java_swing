 ...
 * @author Hridoy Datta
 */
public class Server_Side_028 extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Server_Side_028().setVisible(true);
            }
        });
        String message="";
        try{
            srvr_028 = new ServerSocket(10028);
            sckt_028 = srvr_028.accept();
            ...
            while(true){
                ...
                jTextArea1.getText();
                jTextArea1.setText(jTextArea1.getText()+"From Client : "+message+"\n");
            }
        }catch(Exception e){
